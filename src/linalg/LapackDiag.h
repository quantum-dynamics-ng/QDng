...
namespace LAPACK {
   ...
   extern int DiagGeneral(cMat *mat, cVec* evals, cMat* evecsL, cMat* evecsR);

   extern int DiagHessenberg(cMat *mat, cVec* evals, cMat* evecsL, cMat* evecsR);

   extern int InvertGeneral(cMat *mat);
   ...
   extern "C" {
      ...
      *          < 0:  if INFO = -i, the i-th argument had an illegal value.
      */
      extern void ZGEHRD_F77(const int* N, const int*ILO, const int*IHI,
               dcomplex* A, const int* LDA, dcomplex* TAU, dcomplex* WORK, int* LWORK, int* INFO );
     ...
     */
      extern void ZGETRF_F77(const int* M, const int *N, dcomplex* A, const int* LDA, int* IPIV, int* INFO );
      ...
      */
      extern void ZGETRI_F77(const int* N, dcomplex* A, const int* LDA, const int* IPIV,
